 ...
 ?>	<?php $nam=$row['vote'];?>
          ...
          <div style="margin-top: 100px;" class="col-lg-7 w3l-about-info px-lg-4 align-center">
              ...
              <div class="w3l-btn" style="margin-bottom: 20%;" style="padding: 20%;">
                <form id="my-form1" action="http://localhost/mini/regester.php" name="form2" method="get">
                
                 <a style="margin-top: 30px;width: 200px;height: 50px;padding:13px;" href="regester.php?c_i=<?php echo $row['c_i']?>" class="btn btn-primary"a><span class="span4" style="font-weight: bold;">VOTE</span></a>
...
<?php
                 if(isset($_POST['oncl'])){
                  $nam++;
                 $val=$row['c_i'];
                 $sql = "UPDATE bsc SET vote=$nam where c_id=$val";
                 $con->query($sql);
                 }
                 ?>
          </div>

		...
		<!-- /inner_content-->
				<div class="inner_content">
                    ...
                    <div class="col-md-2 mb-3">
                        ...
                        <input style="height:20%;" type="text" name="name"  class="form-contro" required>
                    </div>
                    <div class="col-md-2 mb-3">
                    <labal for="">c_id</labal><br>
                    <input style="height:20%;" type="number" name="c_i"  class="form-contro" required>
					
                    </div>
					<div class="col-md-2 mb-3">
					<labal for="">Image</labal>
					<input style="height:20%;" type="file" name="img"  class="form-contro" required>
                    </div>
					<div class="col-md-2 mb-3">
                    <labal for="">Phno</labal>
                    <input style="height:20%;" type="number" name="phno"  class="form-contro" required>
                    </div>
					<div class="col-md-2 mb-3">
                    <labal for="">Email</labal>
                    <input style="height:20%;" type="mail" name="email"  class="form-contro" required>
                    </div>
					<div class="col-md-2 mb-3">
                    <labal for="">from</labal>
                    <input style="height:20%;" type="text" name="from"  class="form-contro" required>
                    </div>
					<div class="col-md-2 mb-3">
                        <label style="margin-top:10%;" for=""></label><br>
                        <button type="submit" name="in4-submit" class="btn btn-primary">Insert</button>
                    </div>
				</div>
                        </form>

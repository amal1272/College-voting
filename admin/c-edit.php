...
<div class="wthree_agile_admin_info">
		...
		<!-- /inner_content-->
				<div class="inner_content">
                    ...
                    {
                        $c_id= $_GET["c_id"];
                        $users="SELECT *FROM bsc WHERE c_id='$c_id'";
                    ...
                    <div class="col-md-2 mb-3">
                        ...
                        <input style="height:20%;" type="hidden" name="c_id" value="<?=$user['c_id'];?>" class="form-control">
                        </div>
                    <div class="row"></div>
                    <div class="col-md-2 mb-3">
					...
					<div class="col-md-2 mb-3">
                        ...
                        <button type="submit" name="update2" class="btn btn-primary">submit/update</button>
                    </div>
				</div>
                        </form>

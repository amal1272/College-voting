		...
		<!-- /inner_content-->
				<div class="inner_content">
                    ...
                    <div class="col-md-2 mb-6">
                        <labal for="">Dep</labal>
                        <select style="height:20%;" name="dep" required class="form-control" required>
                        <option value="">--selectcdepartment--</option>
                    ...
                    <div class="col-md-2 mb-3">
                        ...
                        <input style="height:20%;" type="password" name="password" class="form-control" required>
                    </div>
					<div class="col-md-2 mb-3">
                        <label style="margin-top:10%;" for=""></label><br>
                        <button type="submit" name="in-submit" class="btn btn-primary">Insert</button>
                    </div>
				</div>
                        </form>

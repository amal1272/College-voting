...
<div class="wthree_agile_admin_info">
		...
		<!-- /inner_content-->
				<div class="inner_content">
                    ...
                    {
                        $c_id= $_GET["c_i"];
                        $users="SELECT *FROM bcom WHERE c_i='$c_id'";
                    ...
                    <div class="col-md-2 mb-3">
                        ...
                        <input style="height:20%;" type="hidden" name="c_i" value="<?=$user['c_i'];?>" class="form-control">
                        </div>
                    <div class="row"></div>
                    <div class="col-md-2 mb-3">
					...
					<div class="col-md-2 mb-3">
                        ...
                        <button type="submit" name="update7" class="btn btn-primary">submit/update</button>
                    </div>
				</div>
                        </form>

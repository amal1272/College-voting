		...
		<!-- /inner_content-->
				<div class="inner_content">
                    ...
                    <div class="col-md-2 mb-3">
                        ...
                        <input style="height:20%;" type="text" name="name"  class="form-control" required>
                    </div>
                    <div class="col-md-2 mb-3">
                    <labal for="">c_id</labal>
                    <input style="height:20%;" type="number" name="c_id"  class="form-control" required>
                    </div>
                    ...
                    <input style="height:20%;" type="number" name="phno"  class="form-control" required>
                    </div>
					<div class="col-md-2 mb-3">
                    <labal for="">Email</labal>
                    <input style="height:20%;" type="mail" name="email"  class="form-control" required>
                    </div>
					<div class="col-md-2 mb-3">
                    <labal for="">from</labal>
                    <input style="height:20%;" type="text" name="from"  class="form-control" required>
                    </div>
					<div class="col-md-2 mb-3">
                        <label style="margin-top:10%;" for=""></label><br>
                        <button type="submit" name="in3-submit" class="btn btn-primary">Insert</button>
                    </div>
				</div>
                        </form>

...
<div class="wthree_agile_admin_info">
		...
		<!-- /inner_content-->
				<div class="inner_content">
                    ...
                    {
                        $c_id= $_GET["id"];
                        $users="SELECT *FROM bsw WHERE id='$c_id'";
                    ...
                    <div class="col-md-2 mb-3">
                        ...
                        <input style="height:20%;" type="hidden" name="id" value="<?=$user['id'];?>" class="form-control">
                        </div>
                    <div class="row"></div>
                    <div class="col-md-2 mb-3">
					...
					<div class="col-md-2 mb-3">
                        ...
                        <button type="submit" name="update6" class="btn btn-primary">submit/update</button>
                    </div>
				</div>
                        </form>

...
<div class="wthree_agile_admin_info">
		...
		<!-- /inner_content-->
				<div class="inner_content">
                    ...
                    {
                        $user_id= $_GET["email"];
                        $users="SELECT *FROM admin WHERE email='$user_id'";
                    ...
                    <div class="col-md-2 mb-3">
                        ...
                        <input style="height:20%;" type="text" name="pass" value="<?=$user['pass'];?>" class="form-control">
                    </div>
					<div class="col-md-2 mb-3">
                        <label style="margin-top:10%;" for=""></label><br>
                        <button type="submit" name="update3" class="btn btn-primary">submit/update</button>
                    </div>
				</div>
                        </form>

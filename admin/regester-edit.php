...
<div class="wthree_agile_admin_info">
		...
		<!-- /inner_content-->
				<div class="inner_content">
                    ...
                    {
                        $user_id= $_GET["email"];
                        $users="SELECT *FROM vote WHERE email='$user_id'";
                    ...
                    <div class="col-md-2 mb-3">
                        ...
                        <input style="height:20%;" type="hidden" name="email" value="<?=$user['email'];?>" class="form-control">
                        </div>
                    <div class="row"></div>
                    <div class="col-md-2 mb-3">
                    ...
                    <div class="col-md-2 mb-6">
                        <labal for="">Dep</labal>
                        <select style="height:20%;" name="dep" required class="form-control">
                        
                        <option value="BSC" <?=$user['dep']=="BSC" ? 'selected':''?>>Bsc</option>
                        <option value="BA" <?=$user['dep']=="BA" ? 'selected':''?>>BA</option>
                        <option value="BBA" <?=$user['dep']=="BBA" ? 'selected':''?>>BBA</option>
                        <option value="B.com" <?=$user['dep']=="B.com" ? 'selected':''?>>B.com</option>
                        </select>
                    </div>
                    <div class="col-md-2 mb-3">
                        <labal for="">password </labal>
                        <input style="height:20%;" type="text" name="password" value="<?=$user['password'];?>" class="form-control">
                    </div>
					<div class="col-md-2 mb-3">

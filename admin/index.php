...
<div class="wthree_agile_admin_info">
		  ...
		  <div class="w3_agileits_top_nav">
			<ul id="gn-menu" class="gn-menu-main">
				...
				<!-- //nav_agile_w3l -->
                <li class="second logo admin"><h1><a href="main-page.html"><i class="fa fa-graduation-cap" aria-hidden="true"></i>amsteem </a></h1></li>
							...
							<div class="registration admin_agile">
												...
												<div class="signin-form profile admin">
													...
													<div class="login-form">
														<form action="..//regester.php" name="form1" method="post" >
															<h5 >Email</h5>

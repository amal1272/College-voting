...
<div class="wthree_agile_admin_info">
		...
		<!-- /inner_content-->
				<div class="inner_content">
                    ...
                    <input style="height:20%;" type="number" name="id"  class="form-contro"required>
                    </div>
					<div class="col-md-2 mb-3">
					<labal for="">Image</labal>
                    <input type="file" name="img"  class="form-cntrol"required>
                    </div>
					<div class="col-md-2 mb-3">
                    ...
                    <input style="height:20%;" type="mail" name="email"  class="form-contrl"required>
                    </div>
					<div class="col-md-2 mb-3">
					...
					<div class="col-md-2 mb-3">
                        ...
                        <button type="submit" name="in7-submit" class="btn btn-primary">Insert</button>
                    </div>
				</div>
                        </form>

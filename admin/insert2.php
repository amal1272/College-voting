		...
		<!-- /inner_content-->
				<div class="inner_content">
                    ...
                    <div class="col-md-2 mb-3">
                        ...
                        <input style="height:20%;" type="text" name="name"  class="form-control">
                    </div>
                    <div class="col-md-2 mb-3">
                    <labal for="">Email </labal>
                    <input style="height:20%;" type="mail" name="email"  class="form-control">
                    </div>
                    <div class="col-md-2 mb-3">
                        <labal for="">password </labal>
                        <input style="height:20%;" type="password" name="password" class="form-control">
                    </div>
					<div class="col-md-2 mb-3">
                        <label style="margin-top:10%;" for=""></label><br>
                        <button type="submit" name="in2-submit" class="btn btn-primary">Insert</button>
                    </div>
				</div>
                        </form>
